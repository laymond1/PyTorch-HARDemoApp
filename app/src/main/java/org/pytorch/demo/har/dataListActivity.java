...
public class dataListActivity extends AbstractListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.rt_har_card_kuhar_click_area).setOnClickListener(v -> {
            final Intent intent = new Intent(dataListActivity.this, model_run.class);
            if(modelName.equals("Temporal_MixShift")){
                intent.putExtra(model_run.INTENT_MODULE_ASSET_NAME,
                        modelName+"/KUHAR_"+ shiftRate+".pt");
            }else{
                intent.putExtra(model_run.INTENT_MODULE_ASSET_NAME,
                        modelName+"/KUHAR.pt");
            };
            intent.putExtra(model_run.INTENT_DATA_ASSET_NAME,
                    "Data/KUHAR.csv");
            intent.putExtra(model_run.INTENT_TITLE_NAME,
                    modelName+ " on KUHAR");
